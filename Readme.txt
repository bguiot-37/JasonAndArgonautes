...
2. Mettre en place une base de données MySQL pour enregistrer le nom des membres de l'équipe. Donc, on crée une table users avec un identifiant (AI) et membres (VARCHAR 255).
